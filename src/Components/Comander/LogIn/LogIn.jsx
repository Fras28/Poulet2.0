...
const LoginComponent = ({ onLoginSuccess }) => {
  ...
  const Show = (
    <svg width="30" viewBox="0 0 762 447" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const donTShow = (
    <svg width="30" viewBox="0 0 847 847" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="login-container">
          <div className='leftLogin'>
            ...
            <form className='formLogIn'>
              ...
              <button type="button" onClick={handleLogin} className="login-submit" disabled={isLoading}>
